...
var runApp = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                spotifyService = new spotify_service_1.default();
                return [4 /*yield*/, spotifyService.authorize(function () { return __awaiter(void 0, void 0, void 0, function () {
                        var twitchService;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    twitchService = new twitch_service_1.default(spotifyService);
                                    return [4 /*yield*/, twitchService.connectToChat()];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
